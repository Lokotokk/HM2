...
let num1 = prompt("Введите число 1 или меньше");
if (num1 === null) {
    alert("Отмена ввода");
} else if (num1 <= 1) {
    alert ("ОК");
} else if (num1 > 1){
    alert("Введено больше 1");
} else if (!+num1) {
    alert("Введено не число");
}


let num2 = prompt("Введите число больше или равное 3");
...
let hundred = Math.floor(userNumber / 100);
if (hundred >= 10) {
    hundred = hundred % 10;
}
let ten = Math.floor((userNumber % 100) / 10);
